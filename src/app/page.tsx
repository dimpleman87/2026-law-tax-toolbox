...
export const metadata: Metadata = {
  ...
  description:
    "手取り逆算・年金シミュレーター・フリーランス税金など65種類の無料Webツール。ビジネス・金融・DX・テキスト解析まで、登録不要でブラウザ上から即利用。",
};
...
const 特徴リスト = [
  ...
  { emoji: "🆓", タイトル: "完全無料・登録不要",  説明: "65種類すべて無料。アカウント作成も不要。" },
          ...
          <div className="使い方ステップ">
            <div className="ステップカード">
              ...
              <div className="ステップテキスト">
                ...
                <p className="ステップ説明">上の検索バーにキーワードを入力するか、カテゴリから選んでください。65種類から目的に合ったツールがすぐ見つかります。</p>
              </div>
            </div>
