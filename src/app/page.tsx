...
export const metadata: Metadata = {
  title: "無料オンラインツール集 | ToolBox — 62種類すべて登録不要",
  description:
    "文字数カウント・ROAS計算・MEO診断・BMI・年齢計算など62種類の無料Webツール。ビジネス・金融・DX・テキスト解析まで、登録不要でブラウザ上から即利用。",
};
...
// ─── 人気ツール（スラッグ指定）────────────────────────────
const 人気ツールスラッグ = [
  "salary-calculator",    // 給与手取り（検索ボリューム大）
  "furusato-nozei",       // ふるさと納税（季節需要）
  "mortgage-calculator",  // 住宅ローン（高需要）
  "side-job-tax",         // 副業確定申告（急増）
  "meo-checker",          // MEO診断（差別化ツール）
  "freelance-tax",        // フリーランス税金
  "year-end-tax-adj",     // 年末調整（11〜12月爆増）
  "consumption-tax-reverse", // 消費税逆算（汎用）
];
...
const シミュレーター特集 = [
  {
    ...
    見出し: "月収から手取りを即計算",
    キャッチ: "給与手取り計算機",
    説明: "月収（額面）・扶養・交通費を入力するだけで健康保険・厚生年金・所得税・住民税・手取り額を一括計算。給与明細の見方や転職交渉に。",
    CTA: "手取りを計算する",
    emoji: "💴",
    color: "#26d9ca",
  },
  {
    ...
    見出し: "住宅ローンを徹底シミュレーション",
    キャッチ: "月返済額・総利息を試算",
    説明: "借入額・金利・返済期間を入力するだけで月返済額・総支払額・利息総額を即計算。元利均等・元金均等・繰上返済シミュレーション対応。",
    CTA: "返済額を計算する",
    emoji: "🏠",
    color: "#6366f1",
  },
...
const 特徴リスト = [
  ...
  { emoji: "🆓", タイトル: "完全無料・登録不要",  説明: "62種類すべて無料。アカウント作成も不要。" },
          ...
          <div className="使い方ステップ">
            <div className="ステップカード">
              ...
              <div className="ステップテキスト">
                ...
                <p className="ステップ説明">上の検索バーにキーワードを入力するか、カテゴリから選んでください。62種類から目的に合ったツールがすぐ見つかります。</p>
              </div>
            </div>
